...
public enum ErrorCode {
    ...
    ISSUED_COUPON_ALREADY_USED(HttpStatus.CONFLICT),
    ...
    COUPON_CODE_ALREADY_USED_CANNOT_DELETE(HttpStatus.CONFLICT),
    ...
    ACTIVITY_PARTICIPATION_ALREADY_EXISTS(HttpStatus.CONFLICT),
    ...
    POINT_TRANSACTION_NOT_FOUND(HttpStatus.NOT_FOUND),
